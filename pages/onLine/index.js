  ...
  getOnLineData: function (shopId) {
    ...
    app.Ajax(
      ...
      function (json) {
        // console.log('~~~', json);
        if (json.success) {
          app.globalData.onLine = json.data;
          const partSalesData = json.data.partSales

          console.log(json.data)
          that.setData({
            shopIds: json.data.shops.list.map(i => { return i.shopId }),
            shopNames: json.data.shops.list.map(i => { return i.shopName }),
            ...
            'partSales.monthDoc': partSalesData.monthGroups.list[that.data.partSales.index]
          })
        } else {
